...
export function LoginModal({ children }: { children: React.ReactNode }) {
  ...
  const handleEmailLogin = async () => {
    ...
    if (signInError) {
      ...
      window.location.assign(user?.user_metadata?.role === "recruiter" ? "/recruiter" : "/dashboard");
      return;
    }
    setIsLoading(false);
  };
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md bg-zinc-900 border border-zinc-800 rounded-3xl p-7 sm:p-8 shadow-2xl text-white data-open:zoom-in-100 data-closed:zoom-out-100 data-open:slide-in-from-bottom-[100vh] data-closed:slide-out-to-bottom-[100vh] duration-500 ease-in-out">
        <DialogHeader className="flex flex-col items-start sm:text-left mt-0 gap-1.5">
          ...
          <DialogDescription className="text-zinc-400 text-xs leading-relaxed max-w-sm">
            Sign in or continue with your account to access your verified skill passport and talent workspace.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex flex-col gap-3.5 mt-2">
          ...
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="email" className="text-zinc-300 font-medium text-xs">Email</Label>
            <Input
              id="email"
              type="email"
              value={email}
          ...
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="password" className="text-zinc-300 font-medium text-xs">Password</Label>
            <Input
              id="password"
              type="password"
              value={password}
