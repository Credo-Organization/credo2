    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md bg-[#18181b] border-zinc-700 rounded-3xl p-8 shadow-2xl data-open:zoom-in-100 data-closed:zoom-out-100 data-open:slide-in-from-bottom-[100vh] data-closed:slide-out-to-bottom-[100vh] duration-500 ease-in-out">
        ...
        <div className="flex flex-col gap-5 mt-6">
          ...
          <Button className="w-full h-12 text-sm font-medium mt-2 bg-[#2a2a2a] hover:bg-white text-white hover:text-black rounded-lg border-0 transition-colors">
            Sign in
          </Button>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Button variant="outline" className="h-14 bg-[#1c1c1c] hover:bg-[#262626] border-0 rounded-xl flex items-center justify-center transition-colors">
