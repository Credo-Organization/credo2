      ...
      <div className="p-4 rounded-2xl bg-white shadow-sm border border-stone-200 backdrop-blur-xl flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full bg-stone-100 border border-stone-200 rounded-xl pl-9 pr-3.5 py-2 text-xs text-stone-900 placeholder:text-stone-400 focus:outline-none focus:border-emerald-400 transition-colors"
          />
        </div>
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="w-10 h-10 rounded-2xl bg-stone-100 border border-stone-200 flex items-center justify-center text-stone-700 group-hover:text-emerald-400 group-hover:scale-105 transition-all">
                      <Award className="w-5 h-5" />
                    </div>
                  ...
                  {/* Title & Issuer */}
                  <div>
                    <h3 className="text-base font-bold text-stone-900 tracking-tight group-hover:text-emerald-400 transition-colors line-clamp-1">
                      {cert.title}
                    </h3>
